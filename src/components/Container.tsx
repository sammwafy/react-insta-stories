...
export default function () {
    ...
    return (
        <div style={{ ...storyContainerStyles, ...styles.container, ...{ width, height } }}>
            ...
            />
            {!preventDefault && <div style={styles.overlay} className="navContainer">
              <div className="navPrev" style={{ width: '50%', zIndex: 999 }} onTouchStart={debouncePause} onTouchEnd={mouseUp('previous')} onMouseDown={debouncePause} onMouseUp={mouseUp('previous')} />
              <div className="navNext" style={{ width: '50%', zIndex: 999 }} onTouchStart={debouncePause} onTouchEnd={mouseUp('next')} onMouseDown={debouncePause} onMouseUp={mouseUp('next')} />
            </div>}
        </div>
    )
}
